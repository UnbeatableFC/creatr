...
export default function PostEditorSettings({
  ...
  return (
    ...
    >
      <DialogContent className="max-w-md bg-slate-900">
        <DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-slate-400">
              {watchedValues.tags.length}/10 tags • Press Enter or
              comma to add
            </p>
          </div>
          ...
          {mode === "create" && (
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setValue("scheduledFor", e.target.value)
                }
                type="datetime-local"
                className="bg-slate-800 text-white custom-date-picker border-slate-600"
