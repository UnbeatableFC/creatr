...
export default function FeedPage() {
  ...
  const { data: trendingPosts, isLoading: trendingLoading } =
    useConvexQuery(api.feed.getTrendingPosts, { limit: 15 });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400">
            Stay up to date with the latest posts from creators you
            follow
          </p>
        </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="flex space-x-2">
              ...
              <Button
                ...
                variant={
                  activeTab === "trending" ? "primary" : "ghost"
                }
                className="flex-1"
              >
                        ...
                        {user.recentPosts &&
                          user.recentPosts.length > 0 && (
                            <div className="text-xs text-slate-400 pl-13">
                              Latest: "
                              {user.recentPosts[0].title.substring(
                                0,
                                30
                              )}
                              ..."
