...
const DashboardLayout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      <aside
        className={cn(
          "fixed top-0 left-0 h-full w-64 bg-slate-800 backdrop-blur-sm border-r border-slate-700 z-50 transition-transform duration-300 lg:translate-x-0",
              ...
              >
                ...
                >
                  ...
                  {item.title === "Create Post" && true && (
                    <Badge
                      className={
                        "ml-auto text-xs bg-orange-500/20 text-orange-300 border-orange-500/30"
                      }
                      variant={"secondary"}
                    >
                      Draft
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <Link href={"/dashboard/settings"}>
            <Button
              ...
              size={"sm"}
              className={
                "w-full justify-start text-slate-300 hover:text-white rounded-xl p-4"
              }
            >
