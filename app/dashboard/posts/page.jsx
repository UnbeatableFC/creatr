      ...
      <Card className="card-glass">
        <CardContent className="p-6">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            >
              <SelectTrigger className="w-full md:w-40 text-white bg-slate-800 border-slate-600">
            ...
            <Select value={sortBy} onValueChange={setSortBy}>
              <SelectTrigger className="w-full md:w-40 bg-slate-800 text-white border-slate-600">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
